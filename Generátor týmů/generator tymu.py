...
#Labels
team_1 = Label(text=random_team_1, font=("Arial", 20, "bold"))
team_1.grid(row=0, column=0, padx=20, pady=20)

team_2 = Label(text=random_team_2, font=("Arial", 20, "bold"))
...
#Labels obrázky
team_1_img_label = Label(image=random_team_1_img)
team_1_img_label.grid(row=1, column=0, padx=20, pady=20)

team_2_img_label = Label(image=random_team_2_img)
